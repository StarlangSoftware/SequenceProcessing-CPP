...
#ifndef SEQUENCEPROCESSING_ADDITIONBYCONSTANT_H
#define SEQUENCEPROCESSING_ADDITIONBYCONSTANT_H

#include <Function/Function.h>

class AdditionByConstant : public Function {
private:
  double constant;

public:
  explicit AdditionByConstant(double constant);
...
#endif // SEQUENCEPROCESSING_ADDITIONBYCONSTANT_H
